...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    list($message, $alert_type) = resetPasswordStaff($db, $nip, $password1, $password2);
}
?>
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nip" id="nip" class="form-control" required maxlength="18" />
                    </div>
                    <div class="mb-3">
                ...
                <div class="mt-2">
                    <div class="col submit-button text-center">
                        <a href="login-pegawai.php"><button class="btn btn-light">Kembali</button></a>
                    </div>
                </div>
            </div>
        </div>
