...
<html lang="en">
  ...
  <header>
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="index.php#kata-sambutan"
                    >Kata Sambutan</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="index.php#alamat"
                    >Alamat dan Kontak</a
                  >
                </li>
              </ul>
    ...
    <section
      class="tugas-jumbotron d-flex align-items-center justify-content-center"
    >
    ...
    <div class="container mt-5">
      ...
      <div class="row mb-3">
        ...
        <div class="col submit-button mb-2">
          <a href="tambah-tugas.php?matkul_id=<?= $matkul_id; ?>"
            ><button class="btn">Berikan Tugas</button></a
          >
          <a href="detail-matkul.php?id=<?= $matkul_id; ?>"
            ><button class="btn">Kembali</button></a
          >
        </div>
      </div>
      <div class="card p-3">
              ...
              <li>
                <div class="row justify-content-between">
                  ...
                  <div class="col-md-2 submit-button">
                    <a
                      href="lihat-tugas.php?tugas_id=<?= $tugas['id']; ?>&matkul_id=<?= $matkul_id; ?>&pertemuan_id=<?= $tugas['pertemuan_id']; ?>"
                      ><button class="btn btn-light mb-1">Lihat</button></a
                    >
                    <form
                      action=""
                      method="post"
                    ...
                    >
                      <input
                        type="hidden"
                        name="delete_tugas_id"
                        value="<?= $tugas['id']; ?>"
                      />
                      <input
                        type="hidden"
                        name="delete_pertemuan_id"
                        value="<?= $tugas['pertemuan_id']; ?>"
                      />
