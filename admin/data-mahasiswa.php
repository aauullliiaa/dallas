...
$mahasiswa = retrieve("SELECT * FROM mahasiswa_profiles");
?>
...
<head>
  ...
  <title>APD Learning Space - Data Mahasiswa</title>
  <!-- Fonts -->
      ...
      <table>
        ...
        <?php foreach ($mahasiswa as $row): ?>
          <tr>
            <td><?= $i; ?></td>
            <td>
              <a href="edit-data-mhs.php?id=<?= $row["user_id"]; ?>">Edit</a> |
              <a href="detail-mahasiswa.php?id=<?= $row["user_id"]; ?>">Lihat</a>
            </td>
            <td><?= $row["nama"] ?></td>
            <td><?= $row["kelas"] ?></td>
            <td><?= $row["nim"] ?></td>
